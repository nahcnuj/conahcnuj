...
mkdir -p "${TMP}/gh-app"
cp "${REPO_SCRIPTS}/get-token.sh" "${TMP}/gh-app/"
cp "${REPO_SCRIPTS}/git-credential-helper.sh" "${TMP}/gh-app/"
cp "${REPO_SCRIPTS}/api-commit.sh" "${TMP}/gh-app/"
cp "${REPO_SCRIPTS}/bot-user-id.sh" "${TMP}/gh-app/"
